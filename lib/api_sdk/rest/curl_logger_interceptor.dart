...
class CurlLoggerInterceptor extends Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    ...
    if (isCurlPrinted) {
      logPrint('╔╣ Request cURL:');
      final curlComps = _cURLRepresentation(options);
      for (var i = 0; i < curlComps.length; ++i) {
        logPrint((i >= 0 ? '║ ' : '') + curlComps[i]);
      }
      _printLine('╚');
    }
  ...
  List<String> _cURLRepresentation(RequestOptions options) {
